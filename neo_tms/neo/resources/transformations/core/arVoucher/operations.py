...
def getVoucherStatusCode(currentStatusEnumVal=None):
    ...
    if currentStatusEnumVal[0] == "ARVS_NULL":
        return "NULL"
    elif currentStatusEnumVal[0] == "ARVS_INELIGIBLE":
        return "INELIGIBLE"
    elif currentStatusEnumVal[0] == "ARVS_ELIGIBLE":
        return "ELIGIBLE"
    elif currentStatusEnumVal[0] == "ARVS_MATCHED_VARIANCE":
        return "MATCHED_WITH_VARIANCE"
    elif currentStatusEnumVal[0] == "ARVS_MATCHED":
        return "MATCHED"
    elif currentStatusEnumVal[0] == "ARVS_CLOSED":
        return "CLOSED"
    elif currentStatusEnumVal[0] == "ARVS_CANCELED":
        return "CANCELLED"


def getVoucherLevelCode(arVoucherLevelEnumVal=None):
    if arVoucherLevelEnumVal in [None, '']:
        return None

    if arVoucherLevelEnumVal[0] == "ARVL_NULL":
        return "NULL"
    elif arVoucherLevelEnumVal[0] == "ARVL_SHIPMENT":
        return "SHIPMENT"
    elif arVoucherLevelEnumVal[0] == "ARVL_CONTAINER":
        return "SHIPMENT_CONTAINER"
    elif arVoucherLevelEnumVal[0] == "ARVL_SHIPMENT_LEG":
        return "SHIPMENT_LEG"
    elif arVoucherLevelEnumVal[0] == "ARVL_SHIPMENT_LEG_CONTAINER":
        return "SHIPMENT_LEG_CONTAINER"
    elif arVoucherLevelEnumVal[0] == "ARVL_NON_OP_FRHT_AR":
